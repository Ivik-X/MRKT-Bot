...
Следовательно, юзаем куриграм/телетон
### **Примечание!**
Если вы из России, возможно, чтобы ваша сессия была работоспособна, придётся использовать прокси. В куриграме, в отличие от телетона, пока не поддерживается прокси mtproto, в нем можете юзать обычные http/socks5. Поэтому выбор библиотеки за вами. В коде ниже будет использоваться куриграм.
